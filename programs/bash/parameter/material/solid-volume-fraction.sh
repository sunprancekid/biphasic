...
## FILENAME: programs/bash/parameters/material/solid-volume-fraction.sh
## PURPOSE: vary values associated with solid volume fraction of an isotropic biphasic material
...
# script filename
FILENAME="programs/bash/parameter/material/solid-volume-fraction.sh"
# script purpouse
PURPOSE="vary the solid volume fraction of a biphasic isotropic material"
...
UNITS="na"
# default description
DESCRIPTION="solid_volume_fraction"
...
help () {
    ...
    echo -e "\n ## SOLID VOLUME FRACTION PARAMETER OPTIONS ##"
