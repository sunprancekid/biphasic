...
## FILENAME: programs/bash/parameters/material/elastic-modulus.sh
## PURPOSE: vary values associated with elastic modulus of an isotropic biphasic material
...
# script filename
FILENAME="programs/bash/parameter/material/elastic-modulus.sh"
# script purpouse
PURPOSE="vary the elastic modulus of a biphasic isotropic material"
...
# default xml path
XML_PATH="Material/material[@id='1']/solid/E"
# default key 
KEY="EM"
# default units
UNITS="MPa"
# default description
DESCRIPTION="elastic_modulus"
...
help () {
    ...
    echo -e "\n ## ELASTIC MODULUS PARAMETER OPTIONS ##"
