...
## FILENAME: programs/bash/parameters/material/permeability.sh
## PURPOSE: vary values associated with permeability of an isotropic biphasic material
...
# script filename
FILENAME="programs/bash/parameter/material/permeability.sh"
# script purpouse
PURPOSE="vary the permeability of a biphasic isotropic material"
...
# default xml path
XML_PATH="Material/material[@id='1']/permeability[@type='perm-const-iso']/perm"
# default key 
KEY="K"
# default units
UNITS="mm^4/N*s"
...
help () {
    ...
    echo -e "\n ## PERMEABILITY PARAMETER OPTIONS ##"
