...
UNITS="mm"
# default description
DESCRIPTION="loading_displacement"
...
help () {
    ...
    echo -e " -k << ARG >>\t| shortcut KEY used to identify parameter."
    echo -e " -u << ARG >>\t| UNITS corresponding to parameter, stored in job config file."
    echo -e " -D << ARG >>\t| single string DESCRIBING parameter, store in job config file."
