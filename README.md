...
1. download and install febio software suite from [installation package](https://febio.org) or [source code](https://github.com/febiosoftware).
	- to check installation, run 'febio --version' from command line.
...
3. download and install visualization software [plotfig]().
...
5. add local python code to envionrment:
	...
	- visualization software: run 'conda develope -e path/to/plotfig/programs/python'
